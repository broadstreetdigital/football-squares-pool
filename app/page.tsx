    ...
    <div className="min-h-screen bg-football-field relative">
      ...
      <nav className="relative z-10 container mx-auto pl-16 pr-4 md:px-20 py-6">
        <div className="flex flex-row justify-between items-center gap-4">
          <h1 className="font-display text-[2.1rem] sm:text-4xl text-stadium-gold leading-[0.9] flex items-center gap-2 sm:gap-3">
      ...
      <main className="relative z-10 container mx-auto pl-16 pr-4 md:px-20 py-6 md:py-16">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="font-display text-[2.25rem] leading-[1.1] sm:text-8xl text-white mb-4 sm:mb-6 sm:leading-[0.95]">
      ...
      {/* Footer */}
      <footer className="relative z-10 container mx-auto pl-16 pr-4 md:px-20 py-8 mt-24 border-t border-white/10">
